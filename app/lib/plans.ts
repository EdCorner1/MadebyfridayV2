...
export const PLANS: PlanConfig[] = [
  ...
  },
  {
    ...
    price: '$19',
    interval: 'one-time',
    scripts: 'Unlimited rewrites',
    description: 'Lifetime Pro access for the first 100 creators. No monthly bill, no nonsense.',
    cta: 'Go unlimited',
    featured: true,
    public: true,
  ...
  },
  {
    ...
    description: 'Monthly Pro access after the first 100 lifetime seats are gone.',
    cta: 'Upgrade to Pro',
    public: false,
